      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 col-lg-6 text-justify content">
            ...
            <a href="#null" id="approveStake" className="button button-soon scrollto">Loading..</a>
            ...
            <a href="#null" id="stake1d" className="button button-soon scrollto" onClick={() => fstake(1)}>Loading..</a>
            <a href="#null" id="stake7d" className="button button-soon scrollto" onClick={() => fstake(7)}>Loading..</a>
            <a href="#null" id="stake28d" className="button button-soon scrollto" onClick={() => fstake(28)}>Loading..</a>
          ...
          <div className="col-12 col-lg-6 pt-4 pt-lg-0 content">
            ...
            <a href="#null" id="unstake" className="button button-soon scrollto" onClick={window.funstake}>Stake First</a>
