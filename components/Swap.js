function Swap() {
  ...
  return (
    <div id="swap" className="container" style={{padding: "0px"}}>
      <div className="sc-jSFjdj sc-dIvrsQ kJmatq hdzOgI">
        ...
        <div id="swap-page" className="sc-gpEJdM jdQeRJ">
          <div className="sc-enrZtP cXbVbC">
              ...
              <div className="sc-eTTTle hCspWz" style={{padding: "15px"}}>
                <div className="sc-fSvVUw fLBCdk" style={{justifyContent: "space-between"}}>
                  <div className="sc-jSFjdj sc-knSFqH sc-kSCemg kJmatq gIlUEd OGHxE" style={{display: "flex", justifyContent: "space-between"}}>
                    <div fontSize="14px" color="text" className="sc-gtsrHT jFEWVt">From</div>
                    <div fontSize="14px" color="text" className="sc-gtsrHT jFEWVt" style={{display: "inline", cursor: "pointer"}}>
                      Balance:
                ...
                <div className="sc-fVnRWS idBnak" style={{display: "flex"}}>
                  <input id="swapInput" className="sc-iMCRTP iOdHiq token-amount-input" inputMode="decimal" title="Token Amount" autoComplete="off" autoCorrect="off" type="text" pattern="^[0-9]*[.,]?[0-9]*$" placeholder="0.0" minLength="1" maxLength="79" spellCheck="false" value="" style={{caretColor: "white", color: "white"}} readOnly/>
                  <button className="sc-hKFxyN jYLfuR sc-iJKVRt eyGnew open-currency-select-button" scale="sm" style={{justifyContent: "space-between", border: "0px", backgroundColor: "#00000000"}}>
                    <div className="sc-jSFjdj sc-gKAaRy kJmatq eqGhLO" style={{justifyContent: "space-between", display: "flex", alignItems: "center"}}>
            ...
            <div id="swap-currency-input" className="sc-hLiTib isUOgq" style={{borderRadius: "16px", borderColor: "#28a745", border: "solid 3px", boxShadow: "rgb(74 74 104 / 10%) 0px 2px 2px -1px inset"}}>
              <div className="sc-eTTTle hCspWz" style={{padding: "15px"}}>
                <div className="sc-fSvVUw fLBCdk" style={{justifyContent: "space-between"}}>
                  <div className="sc-jSFjdj sc-knSFqH sc-kSCemg kJmatq gIlUEd OGHxE" style={{display: "flex", justifyContent: "space-between"}}>
                    <div fontSize="14px" color="text" className="sc-gtsrHT jFEWVt">To (Estimated)</div>
                    <div fontSize="14px" color="text" className="sc-gtsrHT jFEWVt" style={{display: "inline", cursor: "pointer"}}>
                      Balance:
          ...
          display: "flex",
                  ...
                  <input id="swapOutput" className="sc-iMCRTP iOdHiq token-amount-input" inputMode="decimal" title="Token Amount" autoComplete="off" autoCorrect="off" type="text" pattern="^[0-9]*[.,]?[0-9]*$" placeholder="0.0" minLength="1" maxLength="79" spellCheck="false" value="" style={{caretColor: "white", color: "white"}} readOnly/>
