          ...
          <div className="col-12 col-md-3">
            <div className="count-box">
              <div>
                ...
                <span>$</span><span id="marketcapCounter"></span>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-3">
            <div className="count-box">
              <div>
                ...
                <span id="manualBurnCounter"></span><span>%</span>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-3">
            <div className="count-box">
              <div>
                ...
                <span id="manualLPBurnCounter"></span><span>%</span>
              </div>
            </div>
          </div>
          <div className="col-12 col-md-3">
          ...
          <div className="col-12 col-md-3">
            <div className="count-box">
              <div>
                ...
                <span>x</span><span id="startMultiCounter"></span>
              </div>
            </div>
          </div>
        </div>
