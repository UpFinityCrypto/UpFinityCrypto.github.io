      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-12 text-justify content">
            <div className="row mt-5" style={bigNumber}>
              <div className="col-6 col-lg-3 align-items-stretch center">
                <div className="icon-box">
                    ...
                    <h6 className="text-center ">(<span id="_maxTxNume"></span>% Liq)</h6>
              ...
              <div className="col-6 col-lg-3 align-items-stretch center">
                <div className="icon-box">
                    ...
                    <div>-<span id="taxReduction" className="text-center"></span>%</div>
                </div>
              </div>
            ...
            <div id="myNFT" className="container">
              <div className="section-title">
                <h2>my NFT</h2>
                <p>Total Minted: <span id="totalMyNFTCount"></span></p>
                <p>Buy Tax Reduction: -<span id="taxReduction" className="text-center"></span>%</p>
              </div>
